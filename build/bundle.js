...
var app = (function () {
    ...
    const file$9 = "src/components/Background.svelte";
    ...
    function create_fragment$b(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			attr_dev(div, "class", "background svelte-3m63bl");
    			add_location(div, file$9, 2, 0, 29);
    		},
    ...
    /* src/components/Bookmarks.svelte generated by Svelte v3.38.2 */
    const file$8 = "src/components/Bookmarks.svelte";
    ...
    function create_fragment$a(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$8, 4, 0, 79);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$a($$self, $$props, $$invalidate) {
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console.warn(`<Bookmarks> was created with unknown prop '${key}'`);
    	});
    ...
    const bShowOptionsOverlay = writable(false);
    function toggleShowOptionsOverlay() {
        bShowOptionsOverlay.update(_value => !_value);
        console.log('awdawda');
    }

    /* src/components/OptionsBackgrounds.svelte generated by Svelte v3.38.2 */
    ...
    function instance$9($$self, $$props) {
    	let { $$slots: slots = {}, $$scope } = $$props;
    	validate_slots("OptionsBackgrounds", slots, []);
    	const writable_props = [];

    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console.warn(`<OptionsBackgrounds> was created with unknown prop '${key}'`);
    	});

    	return [];
    }

    class OptionsBackgrounds extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    ...
    /* src/components/OptionsToolbar.svelte generated by Svelte v3.38.2 */

    const file$7 = "src/components/OptionsToolbar.svelte";
    ...
    function create_fragment$8(ctx) {
    	...
    	const block = {
    		c: function create() {
    			main = element("main");
    			add_location(main, file$7, 2, 0, 29);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$8($$self, $$props) {
    	let { $$slots: slots = {}, $$scope } = $$props;
    	validate_slots("OptionsToolbar", slots, []);
    	const writable_props = [];

    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console.warn(`<OptionsToolbar> was created with unknown prop '${key}'`);
    	});

    	return [];
    }

    class OptionsToolbar extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    ...
    // (14:4) {#each menus as menu}
    function create_each_block$1(ctx) {
    	let button;
    	let t_value = /*menu*/ ctx[2] + "";
    	let t;
    	...
    	const block = {
    		c: function create() {
    			...
    			t = text(t_value);
    			attr_dev(button, "class", "svelte-x3azok");
    			add_location(button, file$6, 14, 6, 398);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(14:4) {#each menus as menu}",
    		ctx
    	});
    ...
    function create_if_block_2(ctx) {
    	...
    	let current;
    	optionsbackgrounds = new OptionsBackgrounds({ $$inline: true });

    	const block = {
    		c: function create() {
    			create_component(optionsbackgrounds.$$.fragment);
    		},
    		m: function mount(target, anchor) {
    			mount_component(optionsbackgrounds, target, anchor);
    			current = true;
    		},
    		i: function intro(local) {
    			if (current) return;
    			transition_in(optionsbackgrounds.$$.fragment, local);
    			current = true;
    		},
    		o: function outro(local) {
    			transition_out(optionsbackgrounds.$$.fragment, local);
    			current = false;
    		},
    		d: function destroy(detaching) {
    			destroy_component(optionsbackgrounds, detaching);
    		}
    	};
    ...
    function create_if_block_1(ctx) {
    	let optionstoolbar;
    	let current;
    	optionstoolbar = new OptionsToolbar({ $$inline: true });

    	const block = {
    		c: function create() {
    			create_component(optionstoolbar.$$.fragment);
    		},
    		m: function mount(target, anchor) {
    			mount_component(optionstoolbar, target, anchor);
    			current = true;
    		},
    		i: function intro(local) {
    			if (current) return;
    			transition_in(optionstoolbar.$$.fragment, local);
    			current = true;
    		},
    		o: function outro(local) {
    			transition_out(optionstoolbar.$$.fragment, local);
    			current = false;
    		},
    		d: function destroy(detaching) {
    			destroy_component(optionstoolbar, detaching);
    		}
    	};
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			add_location(div, file$6, 20, 6, 501);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    		},
    ...
    function create_fragment$7(ctx) {
    	...
    	function select_block_type(ctx, dirty) {
    		if (/*menu*/ ctx[2] == "about") return 0;
    		if (/*menu*/ ctx[2] == "toolbar") return 1;
    		if (/*menu*/ ctx[2] == "background") return 2;
    		return -1;
    	}
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div0, "class", "nav svelte-x3azok");
    			add_location(div0, file$6, 12, 2, 348);
    			attr_dev(div1, "class", "content");
    			add_location(div1, file$6, 18, 2, 446);
    			attr_dev(div2, "class", "overlay svelte-x3azok");
    			toggle_class(div2, "open", /*$bShowOptionsOverlay*/ ctx[0]);
    			add_location(div2, file$6, 11, 0, 289);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*$bShowOptionsOverlay*/ 1) {
    				toggle_class(div2, "open", /*$bShowOptionsOverlay*/ ctx[0]);
    			}
    		},
    		i: function intro(local) {
    ...
    function instance$7($$self, $$props, $$invalidate) {
    	let $bShowOptionsOverlay;
    	validate_store(bShowOptionsOverlay, "bShowOptionsOverlay");
    	component_subscribe($$self, bShowOptionsOverlay, $$value => $$invalidate(0, $bShowOptionsOverlay = $$value));
    	let { $$slots: slots = {}, $$scope } = $$props;
    	validate_slots("OptionsOverlay", slots, []);
    	let menus = ["about", "toolbar", "background"];
    	let menu = "about";
    	const writable_props = [];
    	...
    	return [$bShowOptionsOverlay, menus, menu];
    }
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img, file$4, 6, 2, 180);
    			attr_dev(button, "class", "button svelte-1cni8fb");
    			add_location(button, file$4, 5, 0, 136);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$5($$self, $$props, $$invalidate) {
    	...
    	let { svg } = $$props;
    	let { action } = $$props;
    	const writable_props = ["svg", "action"];
    ...
    class IconButton extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$5, create_fragment$5, safe_not_equal, { svg: 0, action: 1 });
    		...
    		if (/*action*/ ctx[1] === undefined && !("action" in props)) {
    			console.warn("<IconButton> was created without expected prop 'action'");
    		}
    	}
    ...
    function instance$4($$self, $$props, $$invalidate) {
    	...
    	const func = () => toggleShowOptionsOverlay();

    	$$self.$capture_state = () => ({
    		SettingsAdjust24,
    		svgs,
    		toggleShowOptionsOverlay,
    		IconButton
    	});
    ...
    function create_each_block(key_1, ctx) {
    	...
    	const block = {
    		...
    		c: function create() {
    			...
    			attr_dev(img, "alt", /*bookmark*/ ctx[0].label);
    			attr_dev(img, "class", "svelte-822lv7");
    			add_location(img, file$3, 7, 6, 225);
    			attr_dev(a, "class", "bookmark svelte-822lv7");
    			attr_dev(a, "href", /*bookmark*/ ctx[0].url);
    			attr_dev(a, "target", "_blank");
    			add_location(a, file$3, 6, 4, 159);
    			this.first = a;
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, a, anchor);
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(span0, file$2, 7, 2, 120);
    			attr_dev(span1, "class", "date");
    			add_location(span1, file$2, 8, 2, 210);
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div0, "class", "svelte-18si43a");
    			add_location(div0, file$1, 8, 4, 264);
    			attr_dev(div1, "class", "right svelte-18si43a");
    			add_location(div1, file$1, 13, 4, 336);
    			attr_dev(div2, "class", "toolbar svelte-18si43a");
    			add_location(div2, file$1, 6, 2, 235);
    			attr_dev(div3, "class", "toolbar-container svelte-18si43a");
    			add_location(div3, file$1, 5, 0, 201);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
